        ...
        <div className="card border-2 border-gray-200 bg-base-100 w-96 shadow-xl bg-white p-5 ">
          ...
          <div className="card-body">
            ...
            <div className="card-actions justify-between mt-6">
              <div className="badge badge-outline border-0 font-semibold text-sm text-gray-500">
                {category}
              </div>
              <div className="badge badge-outline border-0 font-bold text-lg text-gray-500">
                {rating}
